...
$ curl https://raw.githubusercontent.com/appscode/stash/0.6.0-beta.0/hack/deploy/without-rbac.yaml \
  | kubectl apply -f -


# Install with RBAC roles
$ curl https://raw.githubusercontent.com/appscode/stash/0.6.0-beta.0/hack/deploy/with-rbac.yaml \
  | kubectl apply -f -
```
