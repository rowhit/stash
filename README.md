...
|--------------------------------------------------------------------------|-----------------------------------------------------------------------|--------------------|
| [0.6.0-beta.0](https://github.com/appscode/stash/releases/tag/0.6.0-beta.0) (uses CRD) | [User Guide](https://github.com/appscode/stash/tree/0.6.0-beta.0/docs) | 1.7.x+             |
